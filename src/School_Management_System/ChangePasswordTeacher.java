...
public class ChangePasswordTeacher extends JFrame implements ActionListener {
    JFrame welcomeFrame;
    ...
    ChangePasswordTeacher(JFrame welcomeFrame) {
        ...
        //============set Font Label===========
        ltitle = new JLabel("Change Teacher Password");
        ltitle.setBounds(90, 30, 400, 50);
        ...
        if (ae.getSource() == bChangepass) {
            ...
            if (newPassword.equals(confirmPassword)) {
                try {
                    ...
                    String q = "SELECT * FROM Teacher2 WHERE username = ? AND password = ?";
                    ...
                    if (rs.next()) {
                        String q2 = "UPDATE Teacher2 SET password = ? WHERE username = ?";
