...
public class RemoveTeacher extends JFrame {
    ...
    public RemoveTeacher(JFrame studentHomePage) {
        ...
        JButton deleteButton = new JButton("Remove Teacher");
    ...
    private void removeTeacher() {
        ...
        if (selectedRow != -1) {
            ...
            try {
                ...
                String query = "DELETE FROM Teacher2 WHERE username = ?";
                ...
                e.printStackTrace();
                JOptionPane.showMessageDialog(this, "Error removing teacher.");
            }
        } else {
