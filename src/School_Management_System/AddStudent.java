...
public class AddStudent extends JFrame implements ActionListener {
    ...
    AddStudent( JFrame adminHomePage ) {
        ...
        //============set Font Label===========
        ltitle = new JLabel("Add New Student Registration");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == bsubmit) {           
            if (tname.getText().length() == 0) {
                ...
                JOptionPane.showMessageDialog(null, "Student Address Missing");
            } else if (tgender.getText().length() == 0) {
                JOptionPane.showMessageDialog(null, "Enter Gender of Student");
                ...
                JOptionPane.showMessageDialog(null, "Please Enter Age of Student");
                ...
                try {
                    ...
                    PreparedStatement pst = con.prepareStatement("insert into Student2(name,username,email,father,contact,class,address,gender,section,age,dob,securityquestion,answer,password,image)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);");
                    ...
                    JOptionPane.showMessageDialog(null, "Student Add Successefully....");
