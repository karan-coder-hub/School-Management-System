...
public class ForgetPasswordStudent extends JFrame implements ActionListener {
    JFrame welcomeFrame;
    ...
    ForgetPasswordStudent(JFrame welcomeFrame) {
        ...
        //============set Font Label===========
        ltitle = new JLabel("Get Your Password");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == bverify) {
            ...
            try {
                ...
                PreparedStatement pst = con.prepareStatement("select * from Student2 where username='" + username + "';");
        ...
        if (ae.getSource() == bgetpass) {
            if (tans.getText().length() != 0) {
                ...
                try {
                    ...
                    PreparedStatement p = c.prepareStatement("select * from Student2;");
