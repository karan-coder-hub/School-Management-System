...
public class ForgetPasswordAdmin extends JFrame implements ActionListener {
    JFrame welcomeFrame;
    ...
    ForgetPasswordAdmin(JFrame welcomeFrame) {
        ...
        //============set Font Label===========
        ltitle = new JLabel("Get Your Password Admin");
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == bverify) {
            ...
            try {
                ...
                PreparedStatement pst = con.prepareStatement("select * from admin where username='" + username + "';");
                ResultSet rs = pst.executeQuery();
                if (rs.next()) {
                    tysque.setText(rs.getString(4));
        ...
        if (ae.getSource() == bback) {
            new LoginAdmin(welcomeFrame).setVisible(true);
            dispose();
        }
    }
