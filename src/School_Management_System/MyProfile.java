...
public class MyProfile extends JFrame implements ActionListener {
    ...
    JComboBox cb1;
    JFrame teacherHomePage;
    
    JLabel imageLabel;
    File selectedFile, defaultImageFile;
    byte[] buffer;

    MyProfile(String username, JFrame teacherHomePage) {
        ...
        this.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosing(java.awt.event.WindowEvent e) {
                teacherHomePage.setEnabled(true);
            }
        });
    ...
    private void loadTeacherData(String username) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                tteachingEx.setText(rs.getString("teachingExperience"));
                tage.setText(String.valueOf(rs.getInt("age")));
    ...
    private void updateTeacherData() {
        if (tname.getText().length() == 0) {
            ...
            try {
                ...
                PreparedStatement pst = con.prepareStatement("UPDATE Teacher2 SET name=?, password=?, email=?, father=?, contact=?, qualification=?, address=?, gender=?, teachingExperience=?, age=?, dob=?, securityquestion=?, answer=?, image=? WHERE username=?");
                ...
                pst.setString(6, tqualification.getText());
                pst.setString(7, taddress.getText());
                pst.setString(8, tgender.getText());
                pst.setString(9, tteachingEx.getText());
                pst.setInt(10, Integer.parseInt(tage.getText()));
