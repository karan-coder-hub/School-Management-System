...
public class MyProfile2 extends JFrame implements ActionListener {

    JTextField tname, tusername, tpass, temail, tfather, tcontact, taddress, tgender, tage, tdob, tans, cbclass, cbsection;
    ...
    MyProfile2(String username, JFrame studentHomePage) {
        ...
        imageLabel.setBounds(200, 25, 50, 50); // Adjusted for better visibility
        ...
        //============set Font Label===========
        ltitle = new JLabel("My Profile & Edit Profile");
        ...
        //============set Image===================
        ImageIcon img = new ImageIcon("src\\School_Management_System\\Icons\\MyProfile.png");
        lpic = new JLabel(img);
    ...
    public void loadStudentData(String username) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                cbclass.setText(rs.getString("class"));
                taddress.setText(rs.getString("address"));
                tgender.setText(rs.getString("gender"));
                cbsection.setText(rs.getString("section"));
    ...
    private void updateStudentData() {
        if (tname.getText().length() == 0) {
        ...
        } else if (cbclass.getText().length() == 0) {
        ...
        } else if (cbsection.getText().length() == 0) {
            ...
            try {
                ...
                pst.setString(6, cbclass.getText());
                pst.setString(7, taddress.getText());
                pst.setString(8, tgender.getText());
                pst.setString(9, cbsection.getText());
                ...
                Logger.getLogger(MyProfile2.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
    ...
    private void changeImage() {
        JDialog dialog = new JDialog(this, "Change Profile Picture", true); 
        ...
        removeImage.setBounds(75, 40, 150, 40);
        ...
        newImage.setBounds(75, 100, 150, 40);
        newImage.addActionListener(e -> {
            selectImage();
            dialog.dispose();
        });

        dialog.add(removeImage);
        dialog.add(newImage);
